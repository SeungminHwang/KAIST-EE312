module RISCV_TOP (
    ...
    // BTB
    reg[11:0] BranchPointer, partition2, tempPC;
	...
	always @(*) begin
        ...
        if(InitForBranch) nextIR_EX = 32'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx;
		else if(SigStage[1]) nextIR_EX = IR_ID;
		else if(init) nextIR_EX = 32'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx;
		else nextIR_EX = 32'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx;

		if(SigStage[2]) nextIR_MEM = IR_EX;
		else if(init) nextIR_MEM = 32'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx;
		else nextIR_MEM = 32'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx;

		if(SigStage[3]) nextIR_WB = IR_MEM;
		else if(init) nextIR_WB = 32'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx;
		else nextIR_WB = 32'bxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxxx;
	...
	//Stage State
	always @(*) begin
		if((IR_ID[6:0]==7'b1101111)|(IR_ID[6:0]==7'b1100011)|(IR_ID[6:0]==7'b1100111)) begin
			tmp = 0;
		end
		else begin
			tmp = 1;
		...
		if((IR_EX[6:0]==7'b1101111)|(IR_EX[6:0]==7'b1100011)|(IR_EX[6:0]==7'b1100111)) begin
			LocalJump = 1;
		end
		else begin
			LocalJump = 0;
		...
		if((~free)&((IR[19:15]==IR_ID[11:7])|(IR[19:15]==IR_EX[11:7])|(IR[19:15]==IR_MEM[11:7])|(IR[19:15]==IR_WB[11:7])|(IR[24:20]==IR_ID[11:7])|(IR[24:20]==IR_EX[11:7])|(IR[24:20]==IR_MEM[11:7])|(IR[24:20]==IR_WB[11:7]))) begin
			danger = 1;
		end
		else begin
			danger = 0;
		end
		if((IR_ID[6:0]==7'b1100011)) begin
			Finish_BTB = 1;
		end
		else begin
			Finish_BTB = 0;
		...
		treeout = (IR[6:0]==7'b1101111)|(IR[6:0]==7'b1100111); //|(IR[6:0]==7'b1100011); // Jump, JALR
        ...
        //Active_BTB = (I_MEM_DI[6:0]==7'b1100011); // Branch, Always Taken
        Change_BTB = (IR_EX[6:0]==7'b1100011); // Change BTB, Always Taken
		...
		if((danger&tmp2)|check) begin
			...
			nextcheck = 0;
			if((IR_ID[6:0]==7'b1101111)) begin  //opcode == Jump at ID stage, &(~danger)
				case(Counter) 
					3'b001 : begin
						IRWrite = 0;
						nextSigStage[0] = 0;
